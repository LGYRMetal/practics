...
public class DOMConvert2 {
    public static void main(String[] args) {
        ...
        try {
            ...
            // 修改节点
            // 注意：NodeList对象是动态的，所以前面删除节点的操作会影响到
            // NodeList对象，NodeList中的节点对象会重新进行排列，此时，索引
            // 为0的节点是先前节点列表索引中为1的节点
            ...
            // 以converted.xml文件构造一个StreamResult对象，用于保存转换后
            // 结果
            StreamResult result =
            ...
            // 创建一个新的转换器，用于执行恒等转换，即直接将DOM输入源的内容
            // 复制到结果文档中
