    ...
    <?php if ( have_posts() ) : ?>
        <header class="page-header">
            ...
            <?php
                if ( is_category() ) {
                    printf(
                        __( 'Category Archives: %s', 'shape' ),
                        '<span>' . single_cat_title( '', false ) . '</span>'
                    );
                }
                elseif ( is_tag() ) {
                    printf(
                        __( 'Tag Archives: %s', 'shape' ),
                ...
                elseif ( is_day() ) {
                    printf(
                        __( 'Daily Archives: %s', 'shape' ),
                        '<span>' . get_the_date() . '</span>'
                    );
                }
                elseif ( is_month() ) {
                    printf(
                        __( 'Monthly Archives: %s', 'shape' ),
                        '<span>' . get_the_date( 'F Y' ) . '</span>'
                    );
                }
                elseif ( is_year() ) {
                    printf(
                        __( 'Yearly Archives: %s', 'shape' ),
        ...
        <?php shape_content_nav( 'nav-above' ); ?>
            ...
            <?php while ( have_posts() ) : the_post(); ?>
                 ...
                 * content.
                 * If you want to overload this in a child theme then
