...
function shape_content_nav( $nav_id ) {
    ...
    <nav role="navigation"
        ...
        <h1 class="assistive-text">
            <?php _e( 'Post navigation', 'shape' ); ?>
        </h1>

    <?php if ( is_single() ) : // navigation links for single post ?>
        <?php previous_post_link(
            '<div class="nav-previous">%link</div>',
            '<span class="meta-nav">' .
            _x( '&larr;', 'Previous post link', 'shape' ) .
            '</span> %title'
        ); ?>
        <?php next_post_link(
            '<div class="nav-next">%link</div>',
            '%title <span class="meta-nav">' .
            _x( '&rarr;', 'Next post link', 'shape' ) .
            '</span>'
        ); ?>

    <?php //navigation links for home, archive, and search pages
...
?>
            ...
            <p><?php _e( 'Pingback:', 'shape' ); ?> <?php
            comment_author_link(); ?><?php
            edit_comment_link( __( '(Edit)', 'shape' ), ' ' ); ?></p>
<?php
        break;
