                ...
                <header class="entry-header">
                    ...
                    <div class="entry-meta">
                        <?php
                            ...
                            printf(
                                __(
                                    'Published <span class="entry-date">' .
                                    '<time class="entry-date" ' .
                                    'datetime="%1$s" pubdate>%2$s</time>' .
                                    '</span> at <a href="%3$s" ' .
                                    'title="Link to full-size image">' .
                                    '%4$s &times; %5$s</a> in <a ' .
                                    'href="%6$s" title="Return to %7$s" ' .
                                    'rel="gallery">%7$s</a>',
                                    'shape'
                                ),
                ...
                <div class="entry-content">
                    <div class="entry-attachment">
                        <div class="attachment">
                            <?php 
                            /**
                             * Grab the IDs of all the image attachments in
                             * a gallery so we can get the URL of the next
                             * adjacent image in a gallery, or the first
                             * image (if we're looking at the last image
                             * in a gallery), or, in a gallery of one, just
                             * the link to that image file
                             */

                            $attachments =
                                array_values(get_children( array(
                            ...
                            // If there is more than 1 attachment in a
                            // gallery
                            if ( count( $attachments ) > 1 ) {
                                ...
                                // or, if there's only 1 image, get the URL
                                // of the image
                                $next_attachment_url =
                                    wp_get_attachment_url();
                            }
