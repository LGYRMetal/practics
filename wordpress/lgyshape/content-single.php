...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <footer class="entry-meta">
        <?php
            // translators: used between list items, there is a space after
            // the comma
            ...
            if ( ! shape_categorized_blog() ) {
                ...
                if ( '' != $tag_list ) {
                    $meta_text = __(
                        'This entry was tagged %2$s. Bookmark the ' .
                        '<a href="%3$s" title="Permalink to %4$s" ' .
                    ...
                    $meta_text = __(
                        'Bookmark the <a href="%3$s" ' .
                        'title="Permalink to %4$s" ' .
                        'rel="bookmark">permalink</a>.',
                        'shape'
                    );
                }
                ...
                if ( '' != $tag_list ) {
                    ...
                    $meta_text = __(
                        'This entry was posted in %1$s. Bookmark the <a ' .
                        'href="%3$s" title="Permalink to %4$s" ' .
                        'rel="bookmark">permalink</a>.',
                        'shape'
                    );
                }
