    ...
    <div id="comments" class="comments-area">
        ...
        <?php if ( have_comments() ) : ?>
            ...
            ?>
                ...
                </nav><!-- #comment-nav-above .site-navigation
                                              .comment-navigation -->
            ...
            <ol class="commentlist">
                <?php
                /**
                 * Loop through and list the comments. Tell
                 * wp_list_comments() to use shape_comment() to format the
                 * comments.
                 * If you want to overload this in a child theme then you
                 * can define shape_comment() and that will be used instead.
            ...
            <?php // are there comments to navigate through? If so, show
                  // navigation ?>
